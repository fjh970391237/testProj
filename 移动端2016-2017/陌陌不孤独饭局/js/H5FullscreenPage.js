(function(){
         ...
         var obj = {
             ...
             '4' : {
                 ...
                 'nextSlide' : function(item){
                     ...
                     setTimeout(function(){
                         item.removeClass(opt.animateClass).css('-webkit-transform', 'translate3d(0,-100%,0)');
                         item.next().removeClass('zindex').addClass(opt.animateClass).css('-webkit-transform', 'translate3d(0,0,0)');
                     },100);
         ...
         function touchStart(event) {
            ...
            item.addClass(opt.animateClass);
            item.next().addClass(opt.animateClass);
            item.prev().addClass(opt.animateClass);
         ...
         function touchEnd (event) {
            ...
            item.removeClass(opt.animateClass);
            item.next().removeClass(opt.animateClass);
            item.prev().removeClass(opt.animateClass);
